export class Constants {
    public static readonly ACTION_GO_TO: string[] = ["GO_TO", "Go to Quote"];
    public static readonly ACTION_SEND_QUOTE: string[] = ["SEND_QUOTE", "Send Quote"];
    public static readonly ACTION_COPY: string[] = ["COPY", "Copy Quote to Clipboard"];
    public static readonly GUEST_USER: string = 'Guest';

    public static readonly days: string[] = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"];
    public static readonly booksByDay = {
    ...
    public static readonly translations: any[] = [
    ...
    public static readonly translationsShortNms: any[] = [
    ...
    public static readonly bookAbbrev = {
        "genesis": ["Gen", "Genesis"],
        "exodus": ["Ex", "Exodus"],
    ...
    public static readonly booksByNum = {
        1: "genesis",
        2: "exodus",
        3: "leviticus",
        4: "numbers",
    ...
    public static readonly translationLongNames = {
    ...
    public static readonly translationMediumNames = {
    ...
    public static readonly maxChapterByBook = [
        { bookName: 'genesis', maxChapter: 50 },
        { bookName: 'exodus', maxChapter: 40 },
        { bookName: 'leviticus', maxChapter: 27 },
        { bookName: 'numbers', maxChapter: 36 },
        { bookName: 'deuteronomy', maxChapter: 34 },
        { bookName: 'joshua', maxChapter: 24 },
        { bookName: 'judges', maxChapter: 21 },
        { bookName: 'ruth', maxChapter: 4 },
        { bookName: '1-samuel', maxChapter: 31 },
        { bookName: '2-samuel', maxChapter: 24 },
        { bookName: '1-kings', maxChapter: 22 },
        { bookName: '2-kings', maxChapter: 25 },
        { bookName: '1-chronicles', maxChapter: 29 },
        { bookName: '2-chronicles', maxChapter: 36 },
        { bookName: 'ezra', maxChapter: 10 },
        { bookName: 'nehemiah', maxChapter: 13 },
        { bookName: 'esther', maxChapter: 10 },
        { bookName: 'job', maxChapter: 42 },
        { bookName: 'psalms', maxChapter: 150 },
        { bookName: 'proverbs', maxChapter: 31 },
        { bookName: 'ecclesiastes', maxChapter: 12 },
        { bookName: 'song-of-solomon', maxChapter: 8 },
        { bookName: 'isaiah', maxChapter: 66 },
        { bookName: 'jeremiah', maxChapter: 52 },
        { bookName: 'lamentations', maxChapter: 5 },
        { bookName: 'ezekiel', maxChapter: 48 },
        { bookName: 'daniel', maxChapter: 12 },
        { bookName: 'hosea', maxChapter: 14 },
        { bookName: 'joel', maxChapter: 3 },
        { bookName: 'amos', maxChapter: 9 },
        { bookName: 'obadiah', maxChapter: 1 },
        { bookName: 'jonah', maxChapter: 4 },
        { bookName: 'micah', maxChapter: 7 },
        { bookName: 'nahum', maxChapter: 3 },
        { bookName: 'habakkuk', maxChapter: 3 },
        { bookName: 'zephaniah', maxChapter: 3 },
        { bookName: 'haggai', maxChapter: 2 },
        { bookName: 'zechariah', maxChapter: 14 },
        { bookName: 'malachi', maxChapter: 4 },
        { bookName: 'matthew', maxChapter: 28 },
        { bookName: 'mark', maxChapter: 16 },
        { bookName: 'luke', maxChapter: 24 },
        { bookName: 'john', maxChapter: 21 },
        { bookName: 'acts', maxChapter: 28 },
        { bookName: 'romans', maxChapter: 16 },
        { bookName: '1-corinthians', maxChapter: 16 },
        { bookName: '2-corinthians', maxChapter: 13 },
        { bookName: 'galatians', maxChapter: 6 },
        { bookName: 'ephesians', maxChapter: 6 },
        { bookName: 'philippians', maxChapter: 4 },
        { bookName: 'colossians', maxChapter: 4 },
        { bookName: '1-thessalonians', maxChapter: 5 },
        { bookName: '2-thessalonians', maxChapter: 3 },
        { bookName: '1-timothy', maxChapter: 6 },
        { bookName: '2-timothy', maxChapter: 4 },
        { bookName: 'titus', maxChapter: 3 },
        { bookName: 'philemon', maxChapter: 1 },
        { bookName: 'hebrews', maxChapter: 13 },
        { bookName: 'james', maxChapter: 5 },
        { bookName: '1-peter', maxChapter: 5 },
        { bookName: '2-peter', maxChapter: 3 },
        { bookName: '1-john', maxChapter: 5 },
        { bookName: '2-john', maxChapter: 1 },
        { bookName: '3-john', maxChapter: 1 },
        { bookName: 'jude', maxChapter: 1 },
        { bookName: 'revelation', maxChapter: 22 },
    ];
    public static readonly maxVerseByBookAndChapter = {
        genesis: [
            [1, 31],
            [2, 25],
            [3, 24],
